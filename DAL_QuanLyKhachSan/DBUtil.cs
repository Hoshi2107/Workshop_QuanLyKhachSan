...
namespace DAL_QuanLyKhachSan
{
    public class DBUtil
    {
        public static string connectionString = @"Data Source=BAOHPGTB01633;Initial Catalog=Xuong_QLKhachSan;Integrated Security=True;Trust Server Certificate=True";
