...
namespace DAL_QuanLyKhachSan
{
    public class DBUtil
    {
        public static string connectionString = @"Data Source=DESKTOP-NTO91QO\DUC08;Initial Catalog=Xuong_QuanLyKhachSan;Integrated Security=True;Trust Server Certificate=True";
