...
namespace DAL_QuanLyKhachSan
{
    public class DBUtil
    {
        public static string connectionString = @"Data Source=DESKTOP-NTO91QO\DUC08;Initial Catalog=QL_KhachSan;Integrated Security=True;Encrypt=True;Trust Server Certificate=True";
