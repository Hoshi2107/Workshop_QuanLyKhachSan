...
namespace DAL_QuanLyKhachSan
{
    public class DBUtil
    {
        public static string connectionString = @"Data Source=MSI\DANHDEPZAI;Initial Catalog=Xuong_QuanLyKhachSan;Integrated Security=True;Trust Server Certificate=True";
